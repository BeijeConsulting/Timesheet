...
//    public @ResponseBody User handleJsonPostRequest(@RequestBody User user, Model model,
...
//	}
//	
////	@RequestMapping(value = "/conferma", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE)
